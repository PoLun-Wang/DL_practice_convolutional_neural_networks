...
## Loads model weights.
with open('04.MNIST_cnn_model_VGG16.config', 'r') as text_file:
    json_config = text_file.read()
    model = Sequential()
    model = model_from_json(json_config)
    model.load_weights('04.MNIST_cnn_model_VGG16.weights')
print(model.summary())
# Compile model.
...
for i in range(num_images):
    img = load_img('02-04.images/numbers_' + str(i) +'.jpg', color_mode='grayscale', target_size=(224, 224))
